  ...
  <div class="home">
    <div class="container">
      ...
      <div class="row1">
        ...
        <div class="col-md-8">
          <div class="intro">
            <h2>Welcome to Ace Pharmaceuticals</h2>
          </div>
          <div class="box">
            <div class="card">
              <p>
...
export default {
  data() {
    return {
      gallerys: [
        { id: 1, image: require("../../assets/gallery/23.jpg") },
        { id: 2, image: require("../../assets/gallery/11.jpg") },
        { id: 5, image: require("../../assets/gallery/2.jpg") },
      ],
    };
  },
  components: {
